function Alert() {
    (async () => {
        ...
        const {
            ...
            title: '- Вы готовы, дети? - Да, капитан! - Тогда введите любые числа от 0 до 100, не больше!',
            html: 'Минимальное значение: <input id="minValue"class="swal2-input>' +
        ...
        console.log(document.getElementById('minValue').value, 
        document.getElementById('maxValue').value)
...
alert(`- Вы готовы, дети? - Да, капитан! - Тогда введите любые числа от 0 до 100, не больше!`);
